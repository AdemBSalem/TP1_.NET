...
namespace TP1_.NET.Controllers
{
    public class MoviesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Title,ReleaseDate,Genre,Price,Rating,DirectorID")] Movie movie)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Title,ReleaseDate,Genre,Price,Rating,DirectorID")] Movie movie)
        {
            if (ModelState.IsValid)
            {
